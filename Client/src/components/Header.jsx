    ...
    return (
        <div className="mx-8 sm:mx-16 xl:mx-24 relative">
            <div className="text-center mt-20 mb-8 ">
                ...
                <h1 className="text-3xl sm:text-6xl font-semibold sm:leading-16text-gray-700">
                    your own
                ...
                <form onSubmit={onSubmitHandler} className=" flex jjustify-between max-w-lg max:sm:scale-75 mx-auto
